...
class IcEventForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'effort_num': forms.NumberInput(attrs={'step': '1', 'class': 'form-control', 'min': 1, 'max': 999}),
            'latitude': forms.NumberInput(attrs={'step': '0.00001', 'class': 'form-control', 'min': -999, 'max': 999}),
            'longitude': forms.NumberInput(attrs={'step': '0.00001', 'class': 'form-control', 'min': -999, 'max': 999}),
            'effort_min': forms.NumberInput(attrs={'step': '0.25', 'class': 'form-control', 'min': 0, 'max': 999999}),
            'ef_duty_cycle': forms.NumberInput(attrs={'class': 'form-control', 'step': '10', 'min': 0, 'max': 99}),
            'ef_pps_hertz': forms.NumberInput(attrs={'class': 'form-control', 'step': '10', 'min': 0, 'max': 300}),
            'ef_voltage': forms.NumberInput(attrs={'class': 'form-control', 'min': 0, 'max': 999}),
            'ef_amps': forms.NumberInput(attrs={'step': '0.1', 'class': 'form-control', 'min': 0, 'max': 99}),
            'ef_watts': forms.NumberInput(attrs={'class': 'form-control', 'min': 0, 'max': 9999}),
            'net_length_ft': forms.NumberInput(attrs={'step': '25', 'class': 'form-control', 'min': 0, 'max': 9999}),
            'net_depth_ft': forms.NumberInput(attrs={'class': 'form-control', 'min': 0, 'max': 99}),
            'mesh_size_in': forms.NumberInput(attrs={'step': '0.25', 'class': 'form-control', 'min': 0, 'max': 99}),
            'start_time': forms.TimeInput(attrs={'type': 'text', 'class': 'form-control', 'data-provider': 'timepickr', 'data-time-hrs': 'true', 'data-allow-input': 'true',}),
            'end_time': forms.TimeInput(attrs={'type': 'text', 'class': 'form-control', 'data-provider': 'timepickr', 'data-time-hrs': 'true', 'data-allow-input': 'true',}),
            ...
            'water_temp_f': forms.NumberInput(attrs={'step': '0.1', 'class': 'form-control', 'min': 0, 'max': 99}),
            'secchi_depth_in': forms.NumberInput(attrs={'step': '0.1', 'class': 'form-control', 'min': 0, 'max': 999}),
            'net_set_type': forms.Select(attrs={'class': 'form-control select', 'data-toggle': 'select', 'placeholder': 'Select...'}),
            'ef_cond': forms.NumberInput(attrs={'step': '0.1', 'class': 'form-control', 'min': 0, 'max': 9999}),
            'water_ph': forms.NumberInput(attrs={'step': '0.01', 'class': 'form-control', 'min': 0, 'max': 99}),
            'egn_panel_num': forms.NumberInput(attrs={'step': '1', 'class': 'form-control', 'min': 0, 'max': 99}),
            ...
            'run_distance': forms.NumberInput(attrs={'step': '0.001', 'class': 'form-control', 'min': 0, 'max': 99}),
            'dipper_cnt': forms.NumberInput(attrs={'step': '1', 'class': 'form-control', 'min': 1, 'max': 3}),
            'air_temp_f': forms.NumberInput(attrs={'step': '0.1', 'class': 'form-control', 'min': 0, 'max': 99}),
            'wind_speed_mph': forms.NumberInput(attrs={'step': '0.1', 'class': 'form-control', 'min': 0, 'max': 99}),
        }
