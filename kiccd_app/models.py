...
class SampleSite(models.Model):
    ...
    latitude = models.DecimalField("Site LAT", max_digits=9, decimal_places=6, blank=True, null=True, db_comment='Latitude of the sampling site location.')
    longitude = models.DecimalField("Site LON", max_digits=9, decimal_places=6, blank=True, null=True, db_comment='Longitude of the sampling site location.')
...
class FishingSite_CF(models.Model):
    ...
    latitude = models.DecimalField("Site LAT", max_digits=9, decimal_places=6, blank=False, null=False, db_comment='Latitude of the contract fishing location.')
    longitude = models.DecimalField("Site LON", max_digits=9, decimal_places=6, blank=False, null=False, db_comment='Longitude of the contract fishing location.')
...
class FishingSite_HP(models.Model):
    ...
    latitude = models.DecimalField("Latitude", max_digits=9, decimal_places=6, blank=False, null=False, db_comment='Latitude of the commercial fishing location.')
    longitude = models.DecimalField("Longitude", max_digits=9, decimal_places=6, blank=False, null=False, db_comment='Longitude of the commercial fishing location.')
